...
---------------------------------------------
Step 1: Creating a new luna-qml.po file
---------------------------------------------
...
luna-qml.pot file from the "contents/locale" directory into your new
LC_MESSAGES directory and rename it luna-qml.po (in other words, change
the extension from .pot to .po). You are now ready to start translating.

--------------------------------------
Step 2: Translate the required strings
--------------------------------------
While you can edit the luna-qml.po file in any text editor, using the
